...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/users')->with('successMsg', 'The user has been submitted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/users')->with('successMsg', 'The user has been updated successfully!');
    }

    public function destroy($id)
    {
        User::where('id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/users')->with('successMsg', 'The user has been removed successfully!');
    }
    ...
    public function postChangePassword(Request $request, $id){
        ...
        return redirect('admin/backend/users')->with('successMsg', 'The user password has been changed successfully!');
    }
}
