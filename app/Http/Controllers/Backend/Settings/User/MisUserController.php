...
class MisUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/mis-users')->with('successMsg', 'The user has been submitted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/mis-users')->with('successMsg', 'The user has been updated successfully!');
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/mis-users')->with('successMsg', 'The user has been removed successfully!');
    }
}
