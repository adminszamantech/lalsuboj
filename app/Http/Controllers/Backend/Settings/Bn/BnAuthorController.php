...
//        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/bn-authors')->with('successMsg', 'The author has been inserted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-authors')->with('successMsg', 'The author has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/bn-authors')->with('successMsg', 'The author has been removed successfully!');
    }
}
