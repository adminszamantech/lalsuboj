...
class BnTagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tag->save();
        return redirect('admin/backend/bn-tags')->with('successMsg', 'The Bangla tag has been inserted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $tag->approval = $request->approval;
        $tag->save();
        return redirect('admin/backend/bn-tags')->with('successMsg', 'The Bangla tag has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        if (is_numeric($id)) {
            ...
            return redirect('admin/backend/bn-tags')->with('successMsg', 'The Bangla tag has been removed successfully!');
        }
    }
}
