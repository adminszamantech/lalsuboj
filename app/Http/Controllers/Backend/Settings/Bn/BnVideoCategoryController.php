...
class BnVideoCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/bn-video-categories')->with('successMsg', 'The category has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-video-categories')->with('successMsg', 'The category has been updated successfully!');
    }

    public function destroy($id)
    {
        BnVideoCategory::where('id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/bn-video-categories')->with('successMsg', 'The category has been removed successfully!');
    }
}
