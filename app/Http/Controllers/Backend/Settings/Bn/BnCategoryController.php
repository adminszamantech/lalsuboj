...
class BnCategoryController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-categories')->with('successMsg', 'The category has been updated successfully!');
    }

    public function destroy($id)
    {
        BnCategory::where('cat_id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/bn-categories')->with('successMsg', 'The category has been removed successfully!');
    }
}
