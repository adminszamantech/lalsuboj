...
class BnSubcategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/bn-subcategories')->with('successMsg', 'The subcategory has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-subcategories')->with('successMsg', 'The subcategory has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/bn-subcategories')->with('successMsg', 'The subcategory has been removed successfully!');
    }
