...
class DivisionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/divisions')->with('successMsg', 'The division has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/divisions')->with('successMsg', 'The division has been updated successfully!');
    }

    public function destroy($id)
    {
        Division::where('division_id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/divisions')->with('successMsg', 'The division has been removed successfully!');
    }
}
