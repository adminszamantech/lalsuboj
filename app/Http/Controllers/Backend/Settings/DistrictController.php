...
class DistrictController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/districts')->with('successMsg', 'The district has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/districts')->with('successMsg', 'The district has been updated successfully!');
    }

    public function destroy($id)
    {
        District::where('district_id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/districts')->with('successMsg', 'The district has been removed successfully!');
    }
}
