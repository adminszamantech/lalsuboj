...
class CountryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/countries')->with('successMsg', 'The country has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/countries')->with('successMsg', 'The country has been updated successfully!');
    }

    public function destroy($id)
    {
        Country::where('country_id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/countries')->with('successMsg', 'The country has been removed successfully!');
    }
}
