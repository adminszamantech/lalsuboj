...
class UpozillaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/upozillas/create')->with('successMsg', 'Upozilla has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $upozilla->upozilla_slug = fFormatURL($request->upozilla_name);
        $upozilla->save();
        return redirect('admin/backend/upozillas')->with('successMsg', 'Upozilla has been updated successfully!');
    }

    public function destroy($id)
    {
        Upozilla::where('upozilla_id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/upozillas')->with('successMsg', 'Upozilla has been deleted successfully!');
    }
