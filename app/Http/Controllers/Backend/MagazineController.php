...
class MagazineController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Clear the cache
        return redirect('admin/backend/magazines')->with('successMsg', 'The magazine has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // Clear the cache
        return redirect('admin/backend/magazines')->with('successMsg', 'The magazine has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/magazines')->with('successMsg', 'The magazine has been removed successfully!');
    }
}
