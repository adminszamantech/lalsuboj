...
class PhotoAlbumController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'albumName'        => 'required',
            'photo'            => 'required',
            'photo.*'          => 'required|mimes:jpg,jpeg,png,gif,webp',
...
//        $album->save();
        ...
        return redirect('admin/backend/photo-albums')->with('successMsg', 'The album has been inserted successfully!');
    }
...
//        $album->user_id = auth()->id();
        ...
        return redirect('admin/backend/photo-albums')->with('successMsg', 'The album has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        if (is_numeric($id)) {
            ...
            PhotoGallery::where('album_id', $id)->delete();
            return redirect('admin/backend/photo-albums')->with('successMsg', 'The album has been removed successfully!');
        }
    }
}
