...
class PhotoAlbumPositionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/photo-album-positions')->with('successMsg', 'The album position has been inserted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/photo-album-positions')->with('successMsg', 'The album position has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        if (is_numeric($id)) {
            ...
            return redirect('admin/backend/photo-album-positions')->with('successMsg', 'The album position has been removed successfully!');
        }
    }
