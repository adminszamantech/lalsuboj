...
class PhotoCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/photo-categories')->with('successMsg', 'The category has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/photo-categories')->with('successMsg', 'The category has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        if(is_numeric($id)){
            ...
            return redirect('admin/backend/photo-categories')->with('successMsg', 'The category has been removed successfully!');
        }
    }
}
