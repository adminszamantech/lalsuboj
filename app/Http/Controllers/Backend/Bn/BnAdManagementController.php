...
class BnAdManagementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/backend/bn-ads')->with('successMsg', 'The ad created successfully!');
    }
...
//        $ad->position = $request->ad_position;
        ...
        return redirect('/admin/backend/bn-ads')->with('successMsg', 'The ad updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/admin/backend/bn-ads')->with('successMsg', 'The ad removed successfully!');
    }
}
