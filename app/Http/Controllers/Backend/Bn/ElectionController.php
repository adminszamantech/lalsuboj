...
class ElectionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/elections')->with('successMsg', 'The election has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/elections')->with('successMsg', 'The election has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        // Clear the cache
        (new ElectionService())->clearCache();
        return redirect('admin/backend/elections')->with('successMsg', 'The election has been removed successfully!');
    }
}
