...
class BnVideoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/bn-videos')->with('successMsg', 'The video has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-videos')->with('successMsg', 'The video has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        // Clear the cache
        (new BnVideoService())->clearCache();
        return redirect('admin/backend/bn-videos')->with('successMsg', 'The video has been removed successfully!');
    }
}
