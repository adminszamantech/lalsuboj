...
class BnBreakingNewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/backend/bn-breaking-news')->with('successMsg', 'The news has been added successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-breaking-news')->with('successMsg', 'The news has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/bn-breaking-news')->with('successMsg', 'The news has been removed successfully!');
    }
}
