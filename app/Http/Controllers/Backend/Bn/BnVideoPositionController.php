...
class BnVideoPositionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/bn-video-position')->with('successMsg', 'The video position has been inserted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-video-position')->with('successMsg', 'The video position has been updated successfully!');
    ...
    public function destroy($id)
    {
        if(is_numeric($id)){
            ...
            return redirect('admin/backend/bn-video-position')->with('successMsg', 'The video position has been removed successfully!');
        }
    }
