...
class BnContentPositionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/bn-content-position')->with('successMsg', 'The content position has been inserted successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/bn-content-position')->with('successMsg', 'The content position has been updated successfully!');
    ...
    public function destroy($id)
    {
        if(is_numeric($id)){
            ...
            return redirect('admin/backend/bn-content-position')->with('successMsg', 'The content position has been removed successfully!');
        }
    }
    ...
    public function postBnSetPosition(Request $request){
        ...
        if($news_position){
            ...
            // }
            return redirect('admin/backend/bn-content-position/change/'.$positionId);
        }else{
            return false;
        }
    }
    ...
    public function updateContentPositionFixed(Request $request){
        ...
        $position->news_id = $request->news_id;
        $position->is_fixed = $request->is_fixed;
        $position->save();
