...
class ManualDocController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/manual-docs')->with('successMsg', 'The document has been uploaded successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/manual-docs')->with('successMsg', 'The document has been updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/manual-docs')->with('successMsg', 'The document has been removed successfully!');
    }
}
