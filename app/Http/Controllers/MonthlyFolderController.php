...
class MonthlyFolderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/monthly-folders')->with('successMsg', 'The monthly folder has been created successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/monthly-folders')->with('successMsg', 'The monthly folder has been updated successfully!');
    }

    public function destroy($id)
    {
        MonthlyFolder::where('folder_id', $id)->update(['deletable' => 2]);
        return redirect('admin/backend/monthly-folders')->with('successMsg', 'The monthly folder has been removed successfully!');
    }
}
