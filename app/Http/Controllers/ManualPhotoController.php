...
class ManualPhotoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backend/manual-photos')->with('successMsg', 'The photo has been uploaded successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/backend/manual-photos')->with('successMsg', 'The photo has been changed successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backend/manual-photos')->with('successMsg', 'The photo has been removed successfully!');
    }
