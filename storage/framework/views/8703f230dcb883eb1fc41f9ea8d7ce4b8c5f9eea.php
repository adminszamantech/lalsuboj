<?php $__env->startSection('title', 'Bn Content Position Edit'); ?>
...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
        <div class="row">
            <form action="<?php echo e(route('bn-content-position.update', $position->position_id)); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
