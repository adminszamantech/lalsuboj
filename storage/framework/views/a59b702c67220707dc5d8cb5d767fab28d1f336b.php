<div class="grid grid-cols-1 md:grid-cols-12 gap-8 py-4 md:mt-8">
    <div class="col-span-12 md:col-span-9 relative md:after:content-[''] md:after:absolute after:top-0 after:-right-4 after:w-[1px] after:h-full md:after:border-r after:border-custom-bc after:dark:border-gray-600">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 md:gap-8 py-4 border-b border-custom-bc dark:border-gray-600">
            <div class="col-span-9 relative md:after:content-[''] md:after:absolute after:top-0 after:-right-4 after:w-[1px] after:h-full md:after:border-r after:border-custom-bc after:dark:border-gray-600 border-b pb-6 md:border-b-0 md:pb-0 border-custom-bc dark:border-gray-600">
                ...
                <a href="<?php echo e(postURL($saradeshContent->category->cat_slug, $saradeshContent->content_id)); ?>" class="grid grid-cols-12 gap-4  h-full hover:no-underline focus:no-underline group group">
                    ...
                    <div class="col-span-12 md:col-span-5 flex flex-col gap-6">
                        <h2 class="category-heading-text dark:text-slate-300 text-base-color group-hover:text-base-color-hover"><?php echo e($saradeshContent->content_heading); ?></h2>
                        <p class="lead-short-text text-[#555555] dark:text-gray-400"><?php echo fGetWord(fFormatString($saradeshContent->content_details), 20); ?></p>
                    </div>
                </a>
                <!-- First Lead Post --->
            </div>
            ...
            <div class="col-span-12 md:col-span-3 mt-6 md:mt-0 ">
                <!-- Second Lead Post --->
                <?php if($saradeshContents[0]): ?>
                    <a href="<?php echo e(postURL($saradeshContents[0]->category->cat_slug, $saradeshContents[0]->content_id)); ?>" class="flex flex-col gap-2 hover:no-underline focus:no-underline group group relative">
                        <div class="overflow-hidden">
                            <img class="w-full group-hover:scale-110 duration-500" src="<?php echo e($saradeshContents[0]->img_bg_path ? asset(config('appconfig.contentImagePath').$saradeshContents[0]->img_bg_path) : asset(config('appconfig.commonImagePath').Cache::get('bnSiteSettings')->og_image)); ?>" alt="">
                        </div>
                        <div>
                            <h2 class="post-title m-0 py-2 dark:text-slate-300 text-base-color group-hover:text-base-color-hover"><?php echo e($saradeshContents[0]->content_heading); ?></h2>
                        </div>
                    </a>
            <?php endif; ?>
            <!--/ Second Lead Post --->
            ...
            <?php $__currentLoopData = $sportBtContents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sportBottomCont): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($sportBottomCont): ?>
                    <a href="<?php echo e(postURL($sportBottomCont->category->cat_slug, $sportBottomCont->content_id)); ?>" class="flex flex-col gap-2 hover:no-underline focus:no-underline group group relative md:after:content-[''] md:after:absolute after:top-0 after:left-4 md:after:w-full md:after:h-full md:after:border-r after:border-custom-bc after:dark:border-gray-600 mb-4 md:mb-0 border-b md:border-b-0 border-custom-bc dark:border-gray-600">
                        ...
                        <div>
                            <h2 class="post-title m-0 py-2 dark:text-slate-300 text-base-color group-hover:text-base-color-hover"><?php echo e($sportBottomCont->content_heading); ?></h2>
                        </div>
                    </a>
                <?php endif; ?>
...
<?php /**PATH /home/szamymni/notundesh24.com/resources/views/frontend/bn/partials/new_saradesh_section.blade.php ENDPATH**/ ?>