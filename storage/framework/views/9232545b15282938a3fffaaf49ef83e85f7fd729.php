...
<?php $__env->startSection('mainContent'); ?>
    ...
    <div class="home-content">
        ...
        <!-- International Section --->
            <?php if(count($internationalContents) > 0): ?>
        ...
        <div class="news_container mt-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-custom-bc dark:border-gray-600 pb-4">
                ...
                <?php endif; ?>
                <?php if($crimeContents->count()): ?>
                    <div>
                        <?php echo $__env->make('frontend.bn.partials.new_crime', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="news_container mt-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-custom-bc dark:border-gray-600 pb-4">
                ...
                <?php endif; ?>
                <?php if($careerContents->count()): ?>
                    <div>
                            <?php echo $__env->make('frontend.bn.partials.new_career', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('frontend.bn.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/szamymni/notundesh24.com/resources/views/frontend/bn/home-new.blade.php ENDPATH**/ ?>