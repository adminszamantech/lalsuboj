<div class="flex flex-col">
    ...
    <div class="latest_post_tab">
        <?php if(count($latestContents) > 0): ?>
            <?php $__currentLoopData = $latestContents->splice(0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(postURL($latContent->category->cat_slug, $latContent->content_id)); ?>" class="grid grid-cols-12 hover:no-underline focus:no-underline group border-b border-custom-bc dark:border-gray-600 py-4 group">
                    <div class="col-span-7">
                        <h2 class="text-[18px] m-0 text-base-color pr-2 group-hover:text-base-color-hover dark:text-slate-300"><strong><?php echo e($latContent->content_heading); ?></strong></h2>
                    </div>
...
<?php /**PATH D:\DevelopingTeam\laragon\www\nutundesh24\resources\views/frontend/bn/partials/latest_posts.blade.php ENDPATH**/ ?>