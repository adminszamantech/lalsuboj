                    ...
                    <form action="<?php echo e(route('admin.update')); ?>" method="post" class="form-horizontal">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="date" id="date" value="<?php echo e(date('Y-m-d', strtotime($counter->date ?? null))); ?>" class="form-control" name="date">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="time" id="time" value="<?php echo e($counter->time ?? null); ?>" name="time" class="form-control">
                                    <?php if($errors->has('total_center')): ?> <span class="text-danger"><?php echo e($errors->first('total_center')); ?></span> <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="status" value="1" <?php if(isset($counter->status)): ?> <?php echo e($counter->status == 1 ? 'checked' : ''); ?> <?php endif; ?>>Active
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="status" value="2"  <?php if(isset($counter->status)): ?> <?php echo e($counter->status == 2 ? 'checked' : ''); ?> <?php endif; ?>>Inactive
                                    </label>
                                </div>
                            </div>
