        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <!-- form start -->
                    <form action="<?php echo e(route('bn-authors.update', $author->author_id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal col-sm-offset-1">
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control col-sm-6" name="author_type" id="author_type">
                                        <?php $__currentLoopData = config('customdata.author_types'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $author_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e($key == $author->author_type ? 'selected' : ''); ?>><?php echo e($author_type); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="author_name" class="form-control" id="author_name" value="<?php echo e($author->author_name); ?>" placeholder="Author name">
                            ...
                            <div class="form-group">
                                <label for="author_slug" class="col-sm-2 control-label">Author Slug
                                    <span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author_slug" class="form-control" id="author_slug" placeholder="Author Slug" value="<?php echo e($author->author_slug); ?>">
                            ...
                            <div class="form-group">
                                <label for="author_name_bn" class="col-sm-2 control-label">Author Name (Bn)
                                    <span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author_name_bn" class="form-control" id="author_name_bn" value="<?php echo e($author->author_name_bn); ?>" placeholder="Author name bangla">
                            ...
                            <div class="form-group">
                                <label for="author_initial" class="col-sm-2 control-label">Author Initial
                                    <span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author_initial" class="form-control" id="author_initial" value="<?php echo e($author->author_initial); ?>" placeholder="Author initial">
                            ...
                            <div class="form-group">
                                <label for="author_initial_bn" class="col-sm-2 control-label">Author Initial (Bn)
                                    <span class="required">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" name="author_initial_bn" class="form-control" id="author_initial_bn" value="<?php echo e($author->author_initial_bn); ?>" placeholder="Author initial bangla">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="author_bio" id="author_bio" class="form-control" placeholder="Author biodata"><?php echo e($author->author_bio); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="author_bio_bn" id="author_bio_bn" class="form-control" placeholder="Author biodata bangla"><?php echo e($author->author_bio_bn); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php if(!empty($author->img_path)): ?>
                                        <img src="<?php echo e(asset(config('appconfig.authorImagePath').$author->img_path)); ?>" alt="<?php echo e($author->author_name); ?>" class="img-thumbnail" style="width: 200px; margin-bottom: 5px;">
                                    <?php endif; ?>
