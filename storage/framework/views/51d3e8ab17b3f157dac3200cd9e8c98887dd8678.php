                        ...
                        <?php if($econoMyContContent): ?>
                            <a href="<?php echo e(postURL($econoMyContContent->category->cat_slug, $econoMyContContent->content_id)); ?>" class="grid grid-cols-1 gap-2 hover:no-underline focus:no-underline group relative after:content-[''] after:absolute after:-bottom-4 after:left-0 after:w-full after:h-[1px] after:dark:border-gray-600 after:dark:border-gray-600">
                                ...
                                <div>
                                    ...
                                    <p class="lead-short-text text-black dark:text-gray-400"><?php echo fGetWord(fFormatString($econoMyContContent->content_details), 10); ?></p>
                                </div>
