...
<?php $__env->startSection('customMeta'); ?>
    ...
    <meta property="og:description" content="<?php echo e(!empty($category->cat_meta_description) ? $category->cat_meta_description : ''); ?>"/>

    <meta name="twitter:title" content="<?php echo e($category->cat_name_bn. ' । '.Cache::get('bnSiteSettings')->site_name); ?>">
    <meta name="twitter:description" content="<?php echo e(!empty($category->cat_meta_description) ? $category->cat_meta_description : ''); ?>">
             ...
             <div class="grid grid-cols-1 md:grid-cols-12 gap-6 mb-4">
                ...
                <?php if(@count($contents) > 0): ?>
                 ...
                 <div class="col-span-12 lg:col-span-4 xl:col-span-3">
                     <div class="flex flex-col gap-3">
                         <div class="ads">
                             <?php echo $__env->make('frontend.bn.ads.category.category-right-one-ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                         </div>
                         <div class="ads">
                             <?php echo $__env->make('frontend.bn.ads.category.category-right-two-ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                         </div>
                         <div class="ads">
                             <?php echo $__env->make('frontend.bn.ads.category.category-right-three-ad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                         </div>
                     </div>
                 </div>
...
<?php echo $__env->make('frontend.bn.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/szamymni/notundesh24.com/resources/views/frontend/bn/category.blade.php ENDPATH**/ ?>