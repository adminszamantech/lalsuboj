...
{{--                                    <input class="form-control" id="normal-tags" name="normalTags" autocomplete="off">--}}
                                    <input type="text" class="form-control" value="{{str_replace('-', ' ', $content->tags)}}" id="ptaginput" name="normalTags" data-role="tagsinput" />
                                </div>
                            </div>
...
@section('custom-js')
    ...
    <script type="text/javascript">
        ...
        $.get('{{ url("admin/backend/subcat-populate?cat_id=") }}' + {{ $content->cat_id }}, function (data) {
        ...
        $.get('{{ url("admin/backend/upozilla-populate?district_id=") }}' + {{ $content->district_id }}, function (data) {
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#author").tokenInput("{{ url('admin/backend/author-search')}}", {
                preventDuplicates: true,
