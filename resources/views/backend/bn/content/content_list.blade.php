                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <div class="row" style="margin-bottom: 5px;">
                            <div class="col-sm-12">
                                <form action="{{ url('/admin/backend/bn-contents') }}" method="get">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form action="{{ url('admin/backend/bn-contents') }}" method="get" class="">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                            ...
                                            <div class="btn-group" role="group">
                                                <a href="{{ url('admin/backend/bn-contents') }}" class="btn bg-aqua-gradient"><i
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @foreach($contents as $no => $content)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ postURL($content->category->cat_slug,$content->content_id) }}"
...
{{--                                        <span class="badge label-danger"><i class="fa fa-close"></i></span>--}}
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('admin/backend/bn-contents/'.$content->content_id) }}" method="post"
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".edit-content").click(function(){
                ...
                $.get('{{ url("/admin/backend/quickupdate-content?id=") }}'+id, function(data) {
                    ...
                    $('#subCategory').empty();
                    $.get('{{ url("/admin/backend/subcat-populate?cat_id=") }}'+categoryId, function(data){
                    ...
                    $('#category').change(function(){ // Pre-populate subcategory dropdown
                        var cat_id = $(this).val();
                        $('#subCategory').empty();
                        $.get('{{ url("/admin/backend/subcat-populate?cat_id=") }}'+cat_id, function(data){
                            $.each(data, function(index, subcatObj){
                                $('#subCategory').append('<option value="'+subcatObj.subcat_id+'">'+subcatObj.subcat_name_bn+'</option>');
                            });
                            $('#subCategory').prepend('<option value="1" selected>--None--</option>');
            ...
            $.get('{{ url("/admin/backend/populate-category") }}', {'cat_id':cat_id}, function(data){
