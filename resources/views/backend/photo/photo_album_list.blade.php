                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <a href="{{ fAlbumURL($album->album_id, $album->category->cat_slug) }}" target="_blank">
                                    <img src="{{ !empty($album->feature_image['img']) ? asset(config('appconfig.photoAlbumImagePath').$album->feature_image['img']) : asset(config('appconfig.commonImagePath').Cache::get('bnSiteSettings')->og_image)  }}">
                                </a>
                            </div>
                            <div class="panel-footer">
                                <a href="{{ fAlbumURL($album->album_id, $album->category->cat_slug) }}" target="_blank">
                                    <p>{{ Str::limit($album->album_name, 40) }}</p>
                                </a>
