...
@section('title', 'আর্কাইভ । '. Cache::get('bnSiteSettings')->site_name)
...
@section('customMeta')
    ...
    <meta property="og:title" content="আর্কাইভ । {{Cache::get('bnSiteSettings')->site_name}}"/>
    ...
    <meta name="twitter:title" content="আর্কাইভ । {{Cache::get('bnSiteSettings')->site_name}}">
