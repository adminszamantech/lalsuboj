                        ...
                        <div class="row news-top-middle-other">
                            <div class="col-md-5 col-sm-5 col-xs-5">
                                <a href="{{ $sURL }}">
                                    <div class="imgbox-sm">
                                        <img
                                            src="{{ $content->img_bg_path ? asset(config('appconfig.contentImagePath').$content->img_bg_path) : asset(config('appconfig.commonImagePath').Cache::get('bnSiteSettings')->og_image) }}"
